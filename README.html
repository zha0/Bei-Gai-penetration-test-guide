...
很抱歉，这篇文章你看到的时候还是粗糙的，文章更改可能出现在各个章节，文章每天都会变更好一点O(∩_∩)O。食用这篇文章的最好方法就是每次有新收获去在指定章节完善它。所以如果你有热情跟我一起进步，有责任心自始至终的完成这篇文章，那么请加群联系我吧。
...
chu![在这里插入图片描述](https://img-blog.csdnimg.cn/20210628205659976.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L25nYWRtaW5x,size_16,color_FFFFFF,t_70)
...
**3306**
3306是MYSQL数据库默认的监听端口，通常部署在中型web系统中。在国内LAMP的配置是非常流行的，对于php+mysql构架的攻击也是属于比较热门的话题。
...
小迪安全视频笔记（7/14才更新到38集左右。）https://www.yuque.com/gemaxianrenhm/hahwdw/rko38g
笔记2已更新完 https://www.cnblogs.com/SnowSec/category/1908585.html?page=2
